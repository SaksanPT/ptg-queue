(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))r(i);new MutationObserver(i=>{for(const s of i)if(s.type==="childList")for(const o of s.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&r(o)}).observe(document,{childList:!0,subtree:!0});function n(i){const s={};return i.integrity&&(s.integrity=i.integrity),i.referrerPolicy&&(s.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?s.credentials="include":i.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(i){if(i.ep)return;i.ep=!0;const s=n(i);fetch(i.href,s)}})();var Kg={exports:{}},Ml={},Gg={exports:{}},le={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e($,Y){var oe=$.length;$.push(Y);e:for(;0<oe;){var Te=oe-1>>>1,ge=$[Te];if(0<i(ge,Y))$[Te]=Y,$[oe]=ge,oe=Te;else break e}}function n($){return $.length===0?null:$[0]}function r($){if($.length===0)return null;var Y=$[0],oe=$.pop();if(oe!==Y){$[0]=oe;e:for(var Te=0,ge=$.length,Re=ge>>>1;Te<Re;){var Qt=2*(Te+1)-1,Xt=$[Qt],Yt=Qt+1,q=$[Yt];if(0>i(Xt,oe))Yt<ge&&0>i(q,Xt)?($[Te]=q,$[Yt]=oe,Te=Yt):($[Te]=Xt,$[Qt]=oe,Te=Qt);else if(Yt<ge&&0>i(q,oe))$[Te]=q,$[Yt]=oe,Te=Yt;else break e}}return Y}function i($,Y){var oe=$.sortIndex-Y.sortIndex;return oe!==0?oe:$.id-Y.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,l=o.now();t.unstable_now=function(){return o.now()-l}}var u=[],h=[],f=1,g=null,y=3,x=!1,P=!1,b=!1,V=typeof setTimeout=="function"?setTimeout:null,S=typeof clearTimeout=="function"?clearTimeout:null,w=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function k($){for(var Y=n(h);Y!==null;){if(Y.callback===null)r(h);else if(Y.startTime<=$)r(h),Y.sortIndex=Y.expirationTime,e(u,Y);else break;Y=n(h)}}function D($){if(b=!1,k($),!P)if(n(u)!==null)P=!0,Ct(B);else{var Y=n(h);Y!==null&&Qe(D,Y.startTime-$)}}function B($,Y){P=!1,b&&(b=!1,S(m),m=-1),x=!0;var oe=y;try{for(k(Y),g=n(u);g!==null&&(!(g.expirationTime>Y)||$&&!A());){var Te=g.callback;if(typeof Te=="function"){g.callback=null,y=g.priorityLevel;var ge=Te(g.expirationTime<=Y);Y=t.unstable_now(),typeof ge=="function"?g.callback=ge:g===n(u)&&r(u),k(Y)}else r(u);g=n(u)}if(g!==null)var Re=!0;else{var Qt=n(h);Qt!==null&&Qe(D,Qt.startTime-Y),Re=!1}return Re}finally{g=null,y=oe,x=!1}}var U=!1,_=null,m=-1,v=5,E=-1;function A(){return!(t.unstable_now()-E<v)}function R(){if(_!==null){var $=t.unstable_now();E=$;var Y=!0;try{Y=_(!0,$)}finally{Y?T():(U=!1,_=null)}}else U=!1}var T;if(typeof w=="function")T=function(){w(R)};else if(typeof MessageChannel<"u"){var gt=new MessageChannel,Tn=gt.port2;gt.port1.onmessage=R,T=function(){Tn.postMessage(null)}}else T=function(){V(R,0)};function Ct($){_=$,U||(U=!0,T())}function Qe($,Y){m=V(function(){$(t.unstable_now())},Y)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function($){$.callback=null},t.unstable_continueExecution=function(){P||x||(P=!0,Ct(B))},t.unstable_forceFrameRate=function($){0>$||125<$?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):v=0<$?Math.floor(1e3/$):5},t.unstable_getCurrentPriorityLevel=function(){return y},t.unstable_getFirstCallbackNode=function(){return n(u)},t.unstable_next=function($){switch(y){case 1:case 2:case 3:var Y=3;break;default:Y=y}var oe=y;y=Y;try{return $()}finally{y=oe}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function($,Y){switch($){case 1:case 2:case 3:case 4:case 5:break;default:$=3}var oe=y;y=$;try{return Y()}finally{y=oe}},t.unstable_scheduleCallback=function($,Y,oe){var Te=t.unstable_now();switch(typeof oe=="object"&&oe!==null?(oe=oe.delay,oe=typeof oe=="number"&&0<oe?Te+oe:Te):oe=Te,$){case 1:var ge=-1;break;case 2:ge=250;break;case 5:ge=1073741823;break;case 4:ge=1e4;break;default:ge=5e3}return ge=oe+ge,$={id:f++,callback:Y,priorityLevel:$,startTime:oe,expirationTime:ge,sortIndex:-1},oe>Te?($.sortIndex=oe,e(h,$),n(u)===null&&$===n(h)&&(b?(S(m),m=-1):b=!0,Qe(D,oe-Te))):($.sortIndex=ge,e(u,$),P||x||(P=!0,Ct(B))),$},t.unstable_shouldYield=A,t.unstable_wrapCallback=function($){var Y=y;return function(){var oe=y;y=Y;try{return $.apply(this,arguments)}finally{y=oe}}}})(oy);sy.exports=oy;var hE=sy.exports;/**
 * @license React
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const yI=t=>t.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase().trim(),je=(t,e)=>{const n=ye.forwardRef(({color:r="currentColor",size:i=24,strokeWidth:s=2,absoluteStrokeWidth:o,className:l="",children:u,...h},f)=>ye.createElement("svg",{ref:f,...gI,width:i,height:i,stroke:r,strokeWidth:o?Number(s)*24/Number(i):s,className:["lucide",`lucide-${yI(t)}`,l].join(" "),...h},[...e.map(([g,y])=>ye.createElement(g,y)),...Array.isArray(u)?u:[u]]));return n.displayName=`${t}`,n};/**
 * @license lucide-react v0.344.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Sl=new Md("@firebase/auth");function dS(t,...e){Sl.logLevel<=ce.WARN&&Sl.warn(`Auth (${os}): ${t}`,...e)}function Ba(t,...e){Sl.logLevel<=ce.ERROR&&Sl.error(`Auth (${os}): ${t}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fi{constructor(){this.refreshToken=null,this.accessToken=null,this.expirationTime=null}get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(e){ee(e.idToken,"internal-error"),ee(typeof e.idToken<"u","internal-error"),ee(typeof e.refreshToken<"u","internal-error");const n="expiresIn"in e&&typeof e.expiresIn<"u"?Number(e.expiresIn):Wm(e.idToken);this.updateTokensAndExpiration(e.idToken,e.refreshToken,n)}updateFromIdToken(e){ee(e.length!==0,"internal-error");const n=Wm(e);this.updateTokensAndExpiration(e,null,n)}async getToken(e,n=!1){return!n&&this.accessToken&&!this.isExpired?this.accessToken:(ee(this.refreshToken,e,"user-token-expired"),this.refreshToken?(await this.refresh(e,this.refreshToken),this.accessToken):null)}clearRefreshToken(){this.refreshToken=null}async refresh(e,n){const{accessToken:r,refreshToken:i,expiresIn:s}=await kS(e,n);this.updateTokensAndExpiration(r,i,Number(s))}updateTokensAndExpiration(e,n,r){this.refreshToken=n||null,this.accessToken=e||null,this.expirationTime=Date.now()+r*1e3}static fromJSON(e,n){const{refreshToken:r,accessToken:i,expirationTime:s}=n,o=new Fi;return r&&(ee(typeof r=="string","internal-error",{appName:e}),o.refreshToken=r),i&&(ee(typeof i=="string","internal-error",{appName:e}),o.accessToken=i),s&&(ee(typeof s=="number","internal-error",{appName:e}),o.expirationTime=s),o}toJSON(){return{refreshToken:this.refreshToken,accessToken:this.accessToken,expirationTime:this.expirationTime}}_assign(e){this.accessToken=e.accessToken,this.refreshToken=e.refreshToken,this.expirationTime=e.expirationTime}_clone(){return Object.assign(new Fi,this.toJSON())}_performRefresh(){return Pn("not implemented")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function KS(t,e,n=!1){const{auth:r}=t;if(Cn(r.app))return Promise.reject(wr(r));const i="reauthenticate";try{const s=await Eo(t,U_(r,i,e,t),n);ee(s.idToken,r,"internal-error");const o=$d(s.idToken);ee(o,r,"internal-error");const{sub:l}=o;return ee(t.uid===l,r,"user-mismatch"),kr._forOperation(t,i,s)}catch(s){throw(s==null?void 0:s.code)==="auth/user-not-found"&&jn(r,"user-mismatch"),s}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function fk(t,e){return e?bn(e):(ee(t._popupRedirectResolver,t,"argument-error"),t._popupRedirectResolver)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vc="webStorageSupport";class eA{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=H_,this._completeRedirectFn=Sk,this._overrideRedirectResult=Ek}async _openPopup(e,n,r,i){var s;Un((s=this.eventManagers[e._key()])===null||s===void 0?void 0:s.manager,"_initialize() not called before _openPopup()");const o=await rg(e,n,r,Sh(),i);return Gk(e,o,qd())}async _openRedirect(e,n,r,i){await this._originValidation(e);const s=await rg(e,n,r,Sh(),i);return rk(s),new Promise(()=>{})}_initialize(e){const n=e._key();if(this.eventManagers[n]){const{manager:i,promise:s}=this.eventManagers[n];return i?Promise.resolve(i):(Un(s,"If manager is not set, promise should be"),s)}const r=this.initAndGetManager(e);return this.eventManagers[n]={promise:r},r.catch(()=>{delete this.eventManagers[n]}),r}async initAndGetManager(e){const n=await Bk(e),r=new Ak(e);return n.register("authEvent",i=>(ee(i==null?void 0:i.authEvent,e,"invalid-auth-event"),{status:r.onEvent(i.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:r},this.iframes[e._key()]=n,r}_isIframeWebStorageSupported(e,n){this.iframes[e._key()].send(vc,{type:vc},i=>{var s;const o=(s=i==null?void 0:i[0])===null||s===void 0?void 0:s[vc];o!==void 0&&n(!!o),jn(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const n=e._key();return this.originValidationPromises[n]||(this.originValidationPromises[n]=Nk(e)),this.originValidationPromises[n]}get _shouldInitProactively(){return O_()||C_()||Hd()}}const tA=eA;var ig="@firebase/auth",sg="1.7.9";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ni=new Md("@firebase/firestore");function bs(){return ni.logLevel}function K(t,...e){if(ni.logLevel<=ce.DEBUG){const n=e.map(Gd);ni.debug(`Firestore (${ls}): ${t}`,...n)}}function zn(t,...e){if(ni.logLevel<=ce.ERROR){const n=e.map(Gd);ni.error(`Firestore (${ls}): ${t}`,...n)}}function Xi(t,...e){if(ni.logLevel<=ce.WARN){const n=e.map(Gd);ni.warn(`Firestore (${ls}): ${t}`,...n)}}function Gd(t){if(typeof t=="string")return t;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function te(t="Unexpected state"){const e=`FIRESTORE (${ls}) INTERNAL ASSERTION FAILED: `+t;throw zn(e),new Error(e)}function _e(t,e){t||te()}function se(t,e){return t}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class r0{constructor(e,n){this.user=n,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${e}`)}}class cA{getToken(){return Promise.resolve(null)}invalidateToken(){}start(e,n){e.enqueueRetryable(()=>n(ct.UNAUTHENTICATED))}shutdown(){}}class hA{constructor(e){this.token=e,this.changeListener=null}getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(e,n){this.changeListener=n,e.enqueueRetryable(()=>n(this.token.user))}shutdown(){this.changeListener=null}}class dA{constructor(e){this.t=e,this.currentUser=ct.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(e,n){_e(this.o===void 0);let r=this.i;const i=u=>this.i!==r?(r=this.i,n(u)):Promise.resolve();let s=new Er;this.o=()=>{this.i++,this.currentUser=this.u(),s.resolve(),s=new Er,e.enqueueRetryable(()=>i(this.currentUser))};const o=()=>{const u=s;e.enqueueRetryable(async()=>{await u.promise,await i(this.currentUser)})},l=u=>{K("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=u,this.o&&(this.auth.addAuthTokenListener(this.o),o())};this.t.onInit(u=>l(u)),setTimeout(()=>{if(!this.auth){const u=this.t.getImmediate({optional:!0});u?l(u):(K("FirebaseAuthCredentialsProvider","Auth not yet detected"),s.resolve(),s=new Er)}},0),o()}getToken(){const e=this.i,n=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(n).then(r=>this.i!==e?(K("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):r?(_e(typeof r.accessToken=="string"),new r0(r.accessToken,this.currentUser)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.o&&this.auth.removeAuthTokenListener(this.o),this.o=void 0}u(){const e=this.auth&&this.auth.getUid();return _e(e===null||typeof e=="string"),new ct(e)}}class fA{constructor(e,n,r){this.l=e,this.h=n,this.P=r,this.type="FirstParty",this.user=ct.FIRST_PARTY,this.I=new Map}T(){return this.P?this.P():null}get headers(){this.I.set("X-Goog-AuthUser",this.l);const e=this.T();return e&&this.I.set("Authorization",e),this.h&&this.I.set("X-Goog-Iam-Authorization-Token",this.h),this.I}}class pA{constructor(e,n,r){this.l=e,this.h=n,this.P=r}getToken(){return Promise.resolve(new fA(this.l,this.h,this.P))}start(e,n){e.enqueueRetryable(()=>n(ct.FIRST_PARTY))}shutdown(){}invalidateToken(){}}class mA{constructor(e){this.value=e,this.type="AppCheck",this.headers=new Map,e&&e.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class gA{constructor(e){this.A=e,this.forceRefresh=!1,this.appCheck=null,this.R=null}start(e,n){_e(this.o===void 0);const r=s=>{s.error!=null&&K("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${s.error.message}`);const o=s.token!==this.R;return this.R=s.token,K("FirebaseAppCheckTokenProvider",`Received ${o?"new":"existing"} token.`),o?n(s.token):Promise.resolve()};this.o=s=>{e.enqueueRetryable(()=>r(s))};const i=s=>{K("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=s,this.o&&this.appCheck.addTokenListener(this.o)};this.A.onInit(s=>i(s)),setTimeout(()=>{if(!this.appCheck){const s=this.A.getImmediate({optional:!0});s?i(s):K("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}},0)}getToken(){const e=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(e).then(n=>n?(_e(typeof n.token=="string"),this.R=n.token,new mA(n.token)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.o&&this.appCheck.removeTokenListener(this.o),this.o=void 0}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class it{constructor(e){this.binaryString=e}static fromBase64String(e){const n=function(i){try{return atob(i)}catch(s){throw typeof DOMException<"u"&&s instanceof DOMException?new o0("Invalid base64 string: "+s):s}}(e);return new it(n)}static fromUint8Array(e){const n=function(i){let s="";for(let o=0;o<i.length;++o)s+=String.fromCharCode(i[o]);return s}(e);return new it(n)}[Symbol.iterator](){let e=0;return{next:()=>e<this.binaryString.length?{value:this.binaryString.charCodeAt(e++),done:!1}:{value:void 0,done:!0}}}toBase64(){return function(n){return btoa(n)}(this.binaryString)}toUint8Array(){return function(n){const r=new Uint8Array(n.length);for(let i=0;i<n.length;i++)r[i]=n.charCodeAt(i);return r}(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(e){return pe(this.binaryString,e.binaryString)}isEqual(e){return this.binaryString===e.binaryString}}it.EMPTY_BYTE_STRING=new it("");const AA=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);function xr(t){if(_e(!!t),typeof t=="string"){let e=0;const n=AA.exec(t);if(_e(!!n),n[1]){let i=n[1];i=(i+"000000000").substr(0,9),e=Number(i)}const r=new Date(t);return{seconds:Math.floor(r.getTime()/1e3),nanos:e}}return{seconds:Oe(t.seconds),nanos:Oe(t.nanos)}}function Oe(t){return typeof t=="number"?t:typeof t=="string"?Number(t):0}function ri(t){return typeof t=="string"?it.fromBase64String(t):it.fromUint8Array(t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const WA=new be(X.comparator);function Bn(){return WA}const g0=new be(X.comparator);function js(...t){let e=g0;for(const n of t)e=e.insert(n.key,n);return e}function y0(t){let e=g0;return t.forEach((n,r)=>e=e.insert(n,r.overlayedDocument)),e}function Wr(){return eo()}function v0(){return eo()}function eo(){return new us(t=>t.toString(),(t,e)=>t.isEqual(e))}const qA=new be(X.comparator),KA=new nt(X.comparator);function ue(...t){let e=KA;for(const n of t)e=e.add(n);return e}const GA=new nt(pe);function QA(){return GA}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hu{constructor(e,n,r,i,s){this.snapshotVersion=e,this.targetChanges=n,this.targetMismatches=r,this.documentUpdates=i,this.resolvedLimboDocuments=s}static createSynthesizedRemoteEventForCurrentChange(e,n,r){const i=new Map;return i.set(e,Bo.createSynthesizedTargetChangeForCurrentChange(e,n,r)),new hu(ie.min(),i,new be(pe),Bn(),ue())}}class Bo{constructor(e,n,r,i,s){this.resumeToken=e,this.current=n,this.addedDocuments=r,this.modifiedDocuments=i,this.removedDocuments=s}static createSynthesizedTargetChangeForCurrentChange(e,n,r){return new Bo(r,n,ue(),ue(),ue())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class af{constructor(){this.Tr=new nt(qe.Er),this.dr=new nt(qe.Ar)}isEmpty(){return this.Tr.isEmpty()}addReference(e,n){const r=new qe(e,n);this.Tr=this.Tr.add(r),this.dr=this.dr.add(r)}Rr(e,n){e.forEach(r=>this.addReference(r,n))}removeReference(e,n){this.Vr(new qe(e,n))}mr(e,n){e.forEach(r=>this.removeReference(r,n))}gr(e){const n=new X(new xe([])),r=new qe(n,e),i=new qe(n,e+1),s=[];return this.dr.forEachInRange([r,i],o=>{this.Vr(o),s.push(o.key)}),s}pr(){this.Tr.forEach(e=>this.Vr(e))}Vr(e){this.Tr=this.Tr.delete(e),this.dr=this.dr.delete(e)}yr(e){const n=new X(new xe([])),r=new qe(n,e),i=new qe(n,e+1);let s=ue();return this.dr.forEachInRange([r,i],o=>{s=s.add(o.key)}),s}containsKey(e){const n=new qe(e,0),r=this.Tr.firstAfterOrEqual(n);return r!==null&&e.isEqual(r.key)}}class qe{constructor(e,n){this.key=e,this.wr=n}static Er(e,n){return X.comparator(e.key,n.key)||pe(e.wr,n.wr)}static Ar(e,n){return pe(e.wr,n.wr)||X.comparator(e.key,n.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class uf{constructor(e,n,r,i){this.targetId=e,this.fromCache=n,this.$i=r,this.Ui=i}static Wi(e,n){let r=ue(),i=ue();for(const s of n.docChanges)switch(s.type){case 0:r=r.add(s.doc.key);break;case 1:i=i.add(s.doc.key)}return new uf(e,n.fromCache,r,i)}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qx{constructor(){this.Gi=!1,this.zi=!1,this.ji=100,this.Hi=function(){return qI()?8:SA(pt())>0?6:4}()}initialize(e,n){this.Ji=e,this.indexManager=n,this.Gi=!0}getDocumentsMatchingQuery(e,n,r,i){const s={result:null};return this.Yi(e,n).next(o=>{s.result=o}).next(()=>{if(!s.result)return this.Zi(e,n,i,r).next(o=>{s.result=o})}).next(()=>{if(s.result)return;const o=new Wx;return this.Xi(e,n,o).next(l=>{if(s.result=l,this.zi)return this.es(e,n,o,l.size)})}).next(()=>s.result)}es(e,n,r,i){return r.documentReadCount<this.ji?(bs()<=ce.DEBUG&&K("QueryEngine","SDK will not create cache indexes for query:",gi(n),"since it only creates cache indexes for collection contains","more than or equal to",this.ji,"documents"),M.resolve()):(bs()<=ce.DEBUG&&K("QueryEngine","Query:",gi(n),"scans",r.documentReadCount,"local documents and returns",i,"documents as results."),r.documentReadCount>this.Hi*i?(bs()<=ce.DEBUG&&K("QueryEngine","The SDK decides to create cache indexes for query:",gi(n),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,vn(n))):M.resolve())}Yi(e,n){if(vg(n))return M.resolve(null);let r=vn(n);return this.indexManager.getIndexType(e,r).next(i=>i===0?null:(n.limit!==null&&i===1&&(n=bh(n,null,"F"),r=vn(n)),this.indexManager.getDocumentsMatchingTarget(e,r).next(s=>{const o=ue(...s);return this.Ji.getDocuments(e,o).next(l=>this.indexManager.getMinOffset(e,r).next(u=>{const h=this.ts(n,l);return this.ns(n,h,o,u.readTime)?this.Yi(e,bh(n,null,"F")):this.rs(e,h,n,u)}))})))}Zi(e,n,r,i){return vg(n)||i.isEqual(ie.min())?M.resolve(null):this.Ji.getDocuments(e,r).next(s=>{const o=this.ts(n,s);return this.ns(n,o,r,i)?M.resolve(null):(bs()<=ce.DEBUG&&K("QueryEngine","Re-using previous result from %s to execute query: %s",i.toString(),gi(n)),this.rs(e,o,n,_A(i,-1)).next(l=>l))})}ts(e,n){let r=new nt(m0(e));return n.forEach((i,s)=>{lu(e,s)&&(r=r.add(s))}),r}ns(e,n,r,i){if(e.limit===null)return!1;if(r.size!==n.size)return!0;const s=e.limitType==="F"?n.last():n.first();return!!s&&(s.hasPendingWrites||s.version.compareTo(i)>0)}Xi(e,n,r){return bs()<=ce.DEBUG&&K("QueryEngine","Using full collection scan to execute query:",gi(n)),this.Ji.getDocumentsMatchingQuery(e,n,Ar.min(),r)}rs(e,n,r,i){return this.Ji.getDocumentsMatchingQuery(e,r,i).next(s=>(n.forEach(o=>{s=s.insert(o.key,o)}),s))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Kx{constructor(e,n,r,i){this.persistence=e,this.ss=n,this.serializer=i,this.os=new be(pe),this._s=new us(s=>Zd(s),ef),this.us=new Map,this.cs=e.getRemoteDocumentCache(),this.Ur=e.getTargetCache(),this.Gr=e.getBundleCache(),this.ls(r)}ls(e){this.documentOverlayCache=this.persistence.getDocumentOverlayCache(e),this.indexManager=this.persistence.getIndexManager(e),this.mutationQueue=this.persistence.getMutationQueue(e,this.indexManager),this.localDocuments=new Ox(this.cs,this.mutationQueue,this.documentOverlayCache,this.indexManager),this.cs.setIndexManager(this.indexManager),this.ss.initialize(this.localDocuments,this.indexManager)}collectGarbage(e){return this.persistence.runTransaction("Collect garbage","readwrite-primary",n=>e.collect(n,this.os))}}function Gx(t,e,n,r){return new Kx(t,e,n,r)}async function L0(t,e){const n=se(t);return await n.persistence.runTransaction("Handle user change","readonly",r=>{let i;return n.mutationQueue.getAllMutationBatches(r).next(s=>(i=s,n.ls(e),n.mutationQueue.getAllMutationBatches(r))).next(s=>{const o=[],l=[];let u=ue();for(const h of i){o.push(h.batchId);for(const f of h.mutations)u=u.add(f.key)}for(const h of s){l.push(h.batchId);for(const f of h.mutations)u=u.add(f.key)}return n.localDocuments.getDocuments(r,u).next(h=>({hs:h,removedBatchIds:o,addedBatchIds:l}))})})}function Qx(t,e){const n=se(t);return n.persistence.runTransaction("Acknowledge batch","readwrite-primary",r=>{const i=e.batch.keys(),s=n.cs.newChangeBuffer({trackRemovals:!0});return function(l,u,h,f){const g=h.batch,y=g.keys();let x=M.resolve();return y.forEach(P=>{x=x.next(()=>f.getEntry(u,P)).next(b=>{const V=h.docVersions.get(P);_e(V!==null),b.version.compareTo(V)<0&&(g.applyToRemoteDocument(b,h),b.isValidDocument()&&(b.setReadTime(h.commitVersion),f.addEntry(b)))})}),x.next(()=>l.mutationQueue.removeMutationBatch(u,g))}(n,r,e,s).next(()=>s.apply(r)).next(()=>n.mutationQueue.performConsistencyCheck(r)).next(()=>n.documentOverlayCache.removeOverlaysForBatchId(r,i,e.batch.batchId)).next(()=>n.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(r,function(l){let u=ue();for(let h=0;h<l.mutationResults.length;++h)l.mutationResults[h].transformResults.length>0&&(u=u.add(l.batch.mutations[h].key));return u}(e))).next(()=>n.localDocuments.getDocuments(r,i))})}function M0(t){const e=se(t);return e.persistence.runTransaction("Get last remote snapshot version","readonly",n=>e.Ur.getLastRemoteSnapshotVersion(n))}function Xx(t,e){const n=se(t),r=e.snapshotVersion;let i=n.os;return n.persistence.runTransaction("Apply remote event","readwrite-primary",s=>{const o=n.cs.newChangeBuffer({trackRemovals:!0});i=n.os;const l=[];e.targetChanges.forEach((f,g)=>{const y=i.get(g);if(!y)return;l.push(n.Ur.removeMatchingKeys(s,f.removedDocuments,g).next(()=>n.Ur.addMatchingKeys(s,f.addedDocuments,g)));let x=y.withSequenceNumber(s.currentSequenceNumber);e.targetMismatches.get(g)!==null?x=x.withResumeToken(it.EMPTY_BYTE_STRING,ie.min()).withLastLimboFreeSnapshotVersion(ie.min()):f.resumeToken.approximateByteSize()>0&&(x=x.withResumeToken(f.resumeToken,r)),i=i.insert(g,x),function(b,V,S){return b.resumeToken.approximateByteSize()===0||V.snapshotVersion.toMicroseconds()-b.snapshotVersion.toMicroseconds()>=3e8?!0:S.addedDocuments.size+S.modifiedDocuments.size+S.removedDocuments.size>0}(y,x,f)&&l.push(n.Ur.updateTargetData(s,x))});let u=Bn(),h=ue();if(e.documentUpdates.forEach(f=>{e.resolvedLimboDocuments.has(f)&&l.push(n.persistence.referenceDelegate.updateLimboDocument(s,f))}),l.push(Yx(s,o,e.documentUpdates).next(f=>{u=f.Ps,h=f.Is})),!r.isEqual(ie.min())){const f=n.Ur.getLastRemoteSnapshotVersion(s).next(g=>n.Ur.setTargetsMetadata(s,s.currentSequenceNumber,r));l.push(f)}return M.waitFor(l).next(()=>o.apply(s)).next(()=>n.localDocuments.getLocalViewOfDocuments(s,u,h)).next(()=>u)}).then(s=>(n.os=i,s))}function Yx(t,e,n){let r=ue(),i=ue();return n.forEach(s=>r=r.add(s)),e.getEntries(t,r).next(s=>{let o=Bn();return n.forEach((l,u)=>{const h=s.get(l);u.isFoundDocument()!==h.isFoundDocument()&&(i=i.add(l)),u.isNoDocument()&&u.version.isEqual(ie.min())?(e.removeEntry(l,u.readTime),o=o.insert(l,u)):!h.isValidDocument()||u.version.compareTo(h.version)>0||u.version.compareTo(h.version)===0&&h.hasPendingWrites?(e.addEntry(u),o=o.insert(l,u)):K("LocalStore","Ignoring outdated watch update for ",l,". Current version:",h.version," Watch version:",u.version)}),{Ps:o,Is:i}})}function Jx(t,e){const n=se(t);return n.persistence.runTransaction("Get next mutation batch","readonly",r=>(e===void 0&&(e=-1),n.mutationQueue.getNextMutationBatchAfterBatchId(r,e)))}function Zx(t,e){const n=se(t);return n.persistence.runTransaction("Allocate target","readwrite",r=>{let i;return n.Ur.getTargetData(r,e).next(s=>s?(i=s,M.resolve(i)):n.Ur.allocateTargetId(r).next(o=>(i=new lr(e,o,"TargetPurposeListen",r.currentSequenceNumber),n.Ur.addTargetData(r,i).next(()=>i))))}).then(r=>{const i=n.os.get(r.targetId);return(i===null||r.snapshotVersion.compareTo(i.snapshotVersion)>0)&&(n.os=n.os.insert(r.targetId,r),n._s.set(e,r.targetId)),r})}async function Mh(t,e,n){const r=se(t),i=r.os.get(e),s=n?"readwrite":"readwrite-primary";try{n||await r.persistence.runTransaction("Release target",s,o=>r.persistence.referenceDelegate.removeTarget(o,i))}catch(o){if(!Uo(o))throw o;K("LocalStore",`Failed to update sequence numbers for target ${e}: ${o}`)}r.os=r.os.remove(e),r._s.delete(i.target)}function Cg(t,e,n){const r=se(t);let i=ie.min(),s=ue();return r.persistence.runTransaction("Execute query","readwrite",o=>function(u,h,f){const g=se(u),y=g._s.get(f);return y!==void 0?M.resolve(g.os.get(y)):g.Ur.getTargetData(h,f)}(r,o,vn(e)).next(l=>{if(l)return i=l.lastLimboFreeSnapshotVersion,r.Ur.getMatchingKeysForTargetId(o,l.targetId).next(u=>{s=u})}).next(()=>r.ss.getDocumentsMatchingQuery(o,e,n?i:ie.min(),n?s:ue())).next(l=>(eR(r,$A(e),l),{documents:l,Ts:s})))}function eR(t,e,n){let r=t.us.get(e)||ie.min();n.forEach((i,s)=>{s.readTime.compareTo(r)>0&&(r=s.readTime)}),t.us.set(e,r)}class Pg{constructor(){this.activeTargetIds=QA()}fs(e){this.activeTargetIds=this.activeTargetIds.add(e)}gs(e){this.activeTargetIds=this.activeTargetIds.delete(e)}Vs(){const e={activeTargetIds:this.activeTargetIds.toArray(),updateTimeMs:Date.now()};return JSON.stringify(e)}}class tR{constructor(){this.so=new Pg,this.oo={},this.onlineStateHandler=null,this.sequenceNumberHandler=null}addPendingMutation(e){}updateMutationState(e,n,r){}addLocalQueryTarget(e,n=!0){return n&&this.so.fs(e),this.oo[e]||"not-current"}updateQueryState(e,n,r){this.oo[e]=n}removeLocalQueryTarget(e){this.so.gs(e)}isLocalQueryTarget(e){return this.so.activeTargetIds.has(e)}clearQueryState(e){delete this.oo[e]}getAllActiveQueryTargets(){return this.so.activeTargetIds}isActiveQueryTarget(e){return this.so.activeTargetIds.has(e)}start(){return this.so=new Pg,Promise.resolve()}handleUserChange(e,n,r){}setOnlineState(e){}shutdown(){}writeSequenceNumber(e){}notifyBundleLoaded(e){}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zi{constructor(e){this.comparator=e?(n,r)=>e(n,r)||X.comparator(n.key,r.key):(n,r)=>X.comparator(n.key,r.key),this.keyedMap=js(),this.sortedSet=new be(this.comparator)}static emptySet(e){return new zi(e.comparator)}has(e){return this.keyedMap.get(e)!=null}get(e){return this.keyedMap.get(e)}first(){return this.sortedSet.minKey()}last(){return this.sortedSet.maxKey()}isEmpty(){return this.sortedSet.isEmpty()}indexOf(e){const n=this.keyedMap.get(e);return n?this.sortedSet.indexOf(n):-1}get size(){return this.sortedSet.size}forEach(e){this.sortedSet.inorderTraversal((n,r)=>(e(n),!1))}add(e){const n=this.delete(e.key);return n.copy(n.keyedMap.insert(e.key,e),n.sortedSet.insert(e,null))}delete(e){const n=this.get(e);return n?this.copy(this.keyedMap.remove(e),this.sortedSet.remove(n)):this}isEqual(e){if(!(e instanceof zi)||this.size!==e.size)return!1;const n=this.sortedSet.getIterator(),r=e.sortedSet.getIterator();for(;n.hasNext();){const i=n.getNext().key,s=r.getNext().key;if(!i.isEqual(s))return!1}return!0}toString(){const e=[];return this.forEach(n=>{e.push(n.toString())}),e.length===0?"DocumentSet ()":`DocumentSet (
  `+e.join(`  
`)+`
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wf{constructor(e,n){if(!isFinite(e)||e<-90||e>90)throw new G(L.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(n)||n<-180||n>180)throw new G(L.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+n);this._lat=e,this._long=n}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(e){return pe(this._lat,e._lat)||pe(this._long,e._long)}}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Wg(t){t=qt(t,wt);const e=qt(t.firestore,Cr);return qR(_f(e),t._key).then(n=>vw(e,t,n))}class yw extends s2{constructor(e){super(),this.firestore=e}convertBytes(e){return new ns(e)}convertReference(e){const n=this.convertDocumentKey(e,this.firestore._databaseId);return new wt(this.firestore,null,n)}}function Ic(t,e,n){t=qt(t,wt);const r=qt(t.firestore,Cr),i=mw(t.converter,e,n);return Eu(r,[uw(If(r),"setDoc",t._key,i,t.converter!==null,n).toMutation(t._key,Wt.none())])}function Sc(t,e,n,...r){t=qt(t,wt);const i=qt(t.firestore,Cr),s=If(i);let o;return o=typeof(e=mt(e))=="string"||e instanceof yu?t2(s,"updateDoc",t._key,e,n,r):e2(s,"updateDoc",t._key,e),Eu(i,[o.toMutation(t._key,Wt.exists(!0))])}function kc(t){return Eu(qt(t.firestore,Cr),[new nf(t._key,Wt.none())])}function qg(t,e){const n=qt(t.firestore,Cr),r=tn(t),i=mw(t.converter,e);return Eu(n,[uw(If(t.firestore),"addDoc",r._key,i,t.converter!==null,{}).toMutation(r._key,Wt.exists(!1))]).then(()=>r)}function Ca(t,...e){var n,r,i;t=mt(t);let s={includeMetadataChanges:!1,source:"default"},o=0;typeof e[o]!="object"||Hg(e[o])||(s=e[o],o++);const l={includeMetadataChanges:s.includeMetadataChanges,source:s.source};if(Hg(e[o])){const g=e[o];e[o]=(n=g.next)===null||n===void 0?void 0:n.bind(g),e[o+1]=(r=g.error)===null||r===void 0?void 0:r.bind(g),e[o+2]=(i=g.complete)===null||i===void 0?void 0:i.bind(g)}let u,h,f;if(t instanceof wt)h=qt(t.firestore,Cr),f=ou(t._key.path),u={next:g=>{e[o]&&e[o](vw(h,t,g))},error:e[o+1],complete:e[o+2]};else{const g=qt(t,gu);h=qt(g.firestore,Cr),f=g._query;const y=new yw(h);u={next:x=>{e[o]&&e[o](new o2(h,y,g,x))},error:e[o+1],complete:e[o+2]},i2(t._query)}return function(y,x,P,b){const V=new rw(b),S=new G0(x,V,P);return y.asyncQueue.enqueueAndForget(async()=>q0(await zh(y),S)),()=>{V.Za(),y.asyncQueue.enqueueAndForget(async()=>K0(await zh(y),S))}}(_f(h),f,l,u)}function Eu(t,e){return function(r,i){const s=new Er;return r.asyncQueue.enqueueAndForget(async()=>OR(await WR(r),i,s)),s.promise}(_f(t),e)}function vw(t,e,n){const r=n.docs.get(e._key),i=new yw(t);return new gw(t,i,e._key,r,new zs(n.hasPendingWrites,n.fromCache),e.converter)}function l2(){return new Sf("serverTimestamp")}(function(e,n=!0){(function(i){ls=i})(os),Qi(new ei("firestore",(r,{instanceIdentifier:i,options:s})=>{const o=r.getProvider("app").getImmediate(),l=new Cr(new dA(r.getProvider("auth-internal")),new gA(r.getProvider("app-check-internal")),function(h,f){if(!Object.prototype.hasOwnProperty.apply(h.options,["projectId"]))throw new G(L.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new So(h.options.projectId,f)}(o,i),o);return s=Object.assign({useFetchStreams:n},s),l._setSettings(s),l},"PUBLIC").setMultipleInstances(!0)),_r(lg,"4.7.3",e),_r(lg,"4.7.3","esm2017")})();const u2={apiKey:"AIzaSyC2J9j3tcBw9lvkTzDPwsf7s3R9zbWLqD8",authDomain:"ptg-smart-queue.firebaseapp.com",projectId:"ptg-smart-queue",storageBucket:"ptg-smart-queue.firebasestorage.app",messagingSenderId:"351203200844",appId:"1:351203200844:web:11ff3e0a7a15539aaa09e9"},Ac="https://upload.wikimedia.org/wikipedia/commons/thumb/5/5e/PTG_Energy_Logo.svg/200px-PTG_Energy_Logo.svg.png",c2=["Trip No.","ชื่อลูกค้า","เบอร์รถ","เที่ยว","คลังที่รับ","ดีเซล B7","แก๊ส 91","E20","แก๊ส 95","เบนซิน","รวม","เวลา"];function h2(){const[t,e]=ye.useState(!1),[n,r]=ye.useState(null),[i,s]=ye.useState(null),[o,l]=ye.useState("main-station"),[u,h]=ye.useState("home"),[f,g]=ye.useState("dashboard"),[y,x]=ye.useState([]),[P,b]=ye.useState([]),[V,S]=ye.useState([{id:"default",name:"ข้อมูลเที่ยวรถ",headers:c2,rows:[]}]),[w,k]=ye.useState("default"),[D,B]=ye.useState({mode:"sequential",playlist:[]}),[U,_]=ye.useState("jfKfPfyJRdk"),[m,v]=ye.useState([]),[E,A]=ye.useState(""),[R,T]=ye.useState(.8),[gt,Tn]=ye.useState(1);ye.useEffect(()=>{if(!window.XLSX){const J=document.createElement("script");J.src="https://cdn.sheetjs.com/xlsx-0.20.1/package/dist/xlsx.full.min.js",J.async=!0,document.body.appendChild(J)}const q=()=>{const H=window.location.hash.replace("#/","").replace("#","").split("/"),Z=H[0]||"home",me=H[1]||"dashboard";["kiosk","tv"].includes(Z)?h(Z):Z==="admin"||["dashboard","trips","stats","youtube","history"].includes(Z)?(h("admin"),g(Z==="admin"?me:Z)):h("home")};q(),window.addEventListener("hashchange",q);try{let J=u2,H="main-station";typeof __firebase_config<"u"&&(J=JSON.parse(__firebase_config),typeof __app_id<"u"&&(H=__app_id.replace(/[^a-zA-Z0-9_-]/g,"_")));const Z=p_(J),me=lA(Z),j=QR(Z);s(j),l(H),WS(me).catch(console.error);const Q=YS(me,O=>{O?(r(O),e(!0)):e(!1)});return()=>{window.removeEventListener("hashchange",q),Q()}}catch(J){console.error("Firebase Init Error:",J),e(!0)}},[]),ye.useEffect(()=>{if(!n||!i)return;const q=Q=>{const O=Q.data();return O?{id:Q.id,...O}:null},J=Ca(Ds(i,"artifacts",o,"public","data","queues"),Q=>{const O=Q.docs.map(q).filter(re=>re);O.sort((re,ne)=>{var ae,Xe,Jt,Ft;return(((Xe=(ae=re.createdAt)==null?void 0:ae.toMillis)==null?void 0:Xe.call(ae))||0)-(((Ft=(Jt=ne.createdAt)==null?void 0:Jt.toMillis)==null?void 0:Ft.call(Jt))||0)}),x(O)}),H=Ca(Ds(i,"artifacts",o,"public","data","history"),Q=>{const O=Q.docs.map(q).filter(re=>re);Z(O)}),Z=Q=>{const O=[...Q].sort((re,ne)=>new Date(ne.completedAt)-new Date(re.completedAt));b(O)},me=Ca(Ds(i,"artifacts",o,"public","data","sheets"),Q=>{const O=Q.docs.map(q).filter(re=>re);O.length>0&&(O.sort((re,ne)=>re.name.localeCompare(ne.name)),S(O),k(re=>O.find(ne=>ne.id===re)?re:O[0].id))}),j=Ca(tn(i,"artifacts",o,"public","data","config","youtube"),Q=>{Q.exists()&&B(Q.data())});return()=>{J(),H(),me(),j()}},[n,i,o]),ye.useEffect(()=>{const q=()=>{let H=window.speechSynthesis.getVoices();if(H.length>0){v(H);const Z=localStorage.getItem("voiceURI");if(!H.find(j=>j.voiceURI===E)){const j=H.filter(ae=>ae.lang.includes("th")),Q=j.find(ae=>ae.name.toLowerCase().includes("google")&&ae.lang.includes("th")),O=j.find(ae=>ae.voiceURI===Z),re=j[0],ne=Q||O||re;ne&&(A(ne.voiceURI),Z||localStorage.setItem("voiceURI",ne.voiceURI))}}};window.speechSynthesis.onvoiceschanged=q,q();const J=setInterval(()=>{window.speechSynthesis.getVoices().length>0&&m.length===0&&(q(),clearInterval(J))},500);return()=>{window.speechSynthesis.onvoiceschanged=null,clearInterval(J)}},[m.length,E]);const Ct=q=>{if(!q)return;window.speechSynthesis.cancel();const J=new SpeechSynthesisUtterance(q);J.lang="th-TH",J.rate=R,J.pitch=gt;const Z=(m.length>0?m:window.speechSynthesis.getVoices()).find(me=>me.voiceURI===E);Z&&(J.voice=Z),window.speechSynthesis.speak(J)},Qe=q=>{window.location.hash=`#/${q}`},$=q=>{const J=(q==null?void 0:q.trim().toLowerCase())||"";if(!J)return null;for(const H of V){const Z=H.headers.findIndex(O=>O==null?void 0:O.includes("เบอร์รถ"))>-1?H.headers.findIndex(O=>O==null?void 0:O.includes("เบอร์รถ")):2,me=H.headers.findIndex(O=>O==null?void 0:O.includes("ชื่อลูกค้า"))>-1?H.headers.findIndex(O=>O==null?void 0:O.includes("ชื่อลูกค้า")):1,j=H.headers.findIndex(O=>O==null?void 0:O.includes("คลัง"))>-1?H.headers.findIndex(O=>O==null?void 0:O.includes("คลัง")):4,Q=H.rows.find(O=>{const re=O.cells[Z]?String(O.cells[Z]).toLowerCase():"";return re===J||re.startsWith(J+"-")||re.includes(J)});if(Q)return{plate:Q.cells[Z],station:Q.cells[me],depot:Q.cells[j],sheetId:H.id,rowId:Q.id}}return null},Y=async q=>{if(i)try{const J=tn(i,"artifacts",o,"public","data","config","metadata"),H=await Wg(J);let Z=H.exists()?(H.data().queueCounter||0)+1:1;const me=JSON.parse(JSON.stringify(q));await qg(Ds(i,"artifacts",o,"public","data","queues"),{...me,queueNumber:`Q${Z.toString().padStart(3,"0")}`,status:"waiting",statusText:q.type==="external"?"รอรับตั๋ว":"รอเรียกคิว",createdAt:l2(),timestamp:new Date().toISOString()}),await Ic(J,{queueCounter:Z},{merge:!0}),alert("จองคิวสำเร็จ!")}catch(J){alert("เกิดข้อผิดพลาด: "+J.message)}},oe=async q=>{if(Ct("เชิญครับ"),q.type==="internal"){const J=(q.plateNumber||"").split("-");if(Ct(`รถเบอร์ ${J[0]}`),J[1]&&Ct(`คุณ${J[1]}`),q.station&&Ct(`ปลายทาง ${q.station.replace(/^[A-Z0-9]+\s*-\s*/i,"").split("-")[0]}`),q.sourceTrip)try{const H=tn(i,"artifacts",o,"public","data","sheets",String(q.sourceTrip.sheetId)),Z=await Wg(H);if(Z.exists()){const me=Z.data().rows.filter(j=>j.id!==q.sourceTrip.rowId);await Sc(H,{rows:me})}}catch{}}else Ct(`บริษัท ${q.company}`),Ct(`รถทะเบียน ${(q.name||"").replace(/([ก-ฮ]+)(\d+)/,"$1 $2")}`);Ct("รับตั๋วครับ"),await Sc(tn(i,"artifacts",o,"public","data","queues",q.id),{status:"called",calledAt:new Date().toISOString()})},Te=async q=>{i&&(await qg(Ds(i,"artifacts",o,"public","data","history"),{...q,completedAt:new Date().toISOString()}),await kc(tn(i,"artifacts",o,"public","data","queues",q.id)))},ge=async()=>{confirm("คุณต้องการล้างประวัติทั้งหมดใช่หรือไม่?")&&P.forEach(q=>kc(tn(i,"artifacts",o,"public","data","history",q.id)))},Re=q=>{const J=q.target.value;A(J),localStorage.setItem("voiceURI",J);const Z=(m.length>0?m:window.speechSynthesis.getVoices()).find(j=>j.voiceURI===J),me=new SpeechSynthesisUtterance("ทดสอบเสียงพูด");me.lang="th-TH",Z&&(me.voice=Z),window.speechSynthesis.speak(me)},Qt=()=>{const[q,J]=ye.useState("internal"),[H,Z]=ye.useState({plate:"",match:"",station:"",trip:"",depot:"",name:"",comp:"",b7:"",g91:"",e20:"",g95:"",srcS:null,srcR:null}),me=Q=>{const O=$(Q);Z({...H,plate:Q,match:(O==null?void 0:O.plate)||"",station:(O==null?void 0:O.station)||"",trip:(O==null?void 0:O.trip)||"",depot:(O==null?void 0:O.depot)||"",srcS:O==null?void 0:O.sheetId,srcR:O==null?void 0:O.rowId})},j=Q=>{Q.preventDefault();const O={type:q,plateNumber:H.match||H.plate,station:H.station||"-",route:H.trip||"-",depot:H.depot||"-",name:H.name||"",company:H.comp||"",sourceTrip:H.srcS&&H.srcR?{sheetId:H.srcS,rowId:H.srcR}:null};if(q==="external"){const re=[];H.b7&&re.push(`B7:${H.b7}`),H.g91&&re.push(`91:${H.g91}`),H.e20&&re.push(`E20:${H.e20}`),H.g95&&re.push(`95:${H.g95}`),O.fuelList=re.join(", ")||"-"}Y(O),Z({plate:"",match:"",station:"",trip:"",depot:"",name:"",comp:"",b7:"",g91:"",e20:"",g95:"",srcS:null,srcR:null})};return I.jsxs("div",{className:"min-h-screen bg-emerald-50 flex flex-col items-center justify-center p-4",children:[I.jsxs("div",{className:"w-full max-w-2xl bg-white rounded-[2.5rem] shadow-2xl overflow-hidden border border-emerald-100 transition-all",children:[I.jsxs("div",{className:"flex bg-gray-50 border-b",children:[I.jsxs("button",{onClick:()=>J("internal"),className:`flex-1 py-8 font-black text-2xl flex items-center justify-center gap-3 transition-all ${q==="internal"?"bg-emerald-600 text-white shadow-inner":"text-emerald-800 hover:bg-emerald-50"}`,children:[I.jsx(hc,{size:32})," ลูกค้าภายใน"]}),I.jsxs("button",{onClick:()=>J("external"),className:`flex-1 py-8 font-black text-2xl flex items-center justify-center gap-3 transition-all ${q==="external"?"bg-teal-600 text-white shadow-inner":"text-teal-800 hover:bg-teal-50"}`,children:[I.jsx(CI,{size:32})," ลูกค้าภายนอก"]})]}),I.jsxs("form",{onSubmit:j,className:"p-10 space-y-8",children:[q==="internal"?I.jsxs("div",{className:"space-y-8 animate-in slide-in-from-bottom-4 duration-500",children:[I.jsxs("div",{children:[I.jsx("label",{className:"block text-lg font-bold text-gray-600 mb-3",children:"ระบุเลขเบอร์รถ"}),I.jsxs("div",{className:"relative",children:[I.jsx(hc,{className:"absolute left-6 top-1/2 -translate-y-1/2 text-gray-400",size:32}),I.jsx("input",{className:"w-full pl-20 p-6 border-4 border-emerald-100 rounded-2xl text-4xl font-black bg-emerald-50/20 focus:border-emerald-500 outline-none transition-all placeholder:text-gray-200",value:H.plate,onChange:Q=>me(Q.target.value),required:!0,placeholder:"เช่น 100"})]}),H.match&&I.jsxs("div",{className:"mt-4 p-4 bg-emerald-500 text-white rounded-2xl font-bold flex items-center gap-3 shadow-lg animate-pulse",children:[I.jsx(xm,{})," ข้อมูลถูกต้อง: ",H.match]})]}),I.jsxs("div",{className:"grid grid-cols-2 gap-6",children:[I.jsxs("div",{className:"p-6 bg-emerald-50 rounded-2xl border-2 border-emerald-100 shadow-inner",children:[I.jsx("span",{className:"text-xs font-black text-emerald-600 uppercase tracking-widest",children:"สถานีปลายทาง"}),I.jsx("p",{className:"text-2xl font-bold text-emerald-900 mt-2 truncate",children:H.station||"-"})]}),I.jsxs("div",{className:"p-6 bg-emerald-50 rounded-2xl border-2 border-emerald-100 shadow-inner",children:[I.jsx("span",{className:"text-xs font-black text-emerald-600 uppercase tracking-widest",children:"คลังรับน้ำมัน"}),I.jsx("p",{className:"text-2xl font-bold text-emerald-900 mt-2 truncate",children:H.depot||"-"})]})]})]}):I.jsxs("div",{className:"space-y-6 animate-in slide-in-from-bottom-4 duration-500",children:[I.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-6",children:[I.jsxs("div",{children:[I.jsx("label",{className:"block text-sm font-bold text-gray-600 mb-2 tracking-tight",children:"ทะเบียนรถ"}),I.jsx("input",{className:"w-full p-4 border-2 border-gray-100 rounded-xl text-xl font-bold focus:border-teal-500 outline-none",value:H.name,onChange:Q=>Z({...H,name:Q.target.value}),required:!0,placeholder:"กข-1234"})]}),I.jsxs("div",{children:[I.jsx("label",{className:"block text-sm font-bold text-gray-600 mb-2 tracking-tight",children:"บริษัท"}),I.jsx("input",{className:"w-full p-4 border-2 border-gray-100 rounded-xl text-xl font-bold focus:border-teal-500 outline-none",value:H.comp,onChange:Q=>Z({...H,comp:Q.target.value}),required:!0,placeholder:"บจก. ก้าวหน้า"})]})]}),I.jsx("div",{className:"p-6 bg-gray-50 rounded-2xl border-2 border-gray-100 grid grid-cols-2 md:grid-cols-4 gap-4",children:["b7","g91","e20","g95"].map(Q=>I.jsxs("div",{children:[I.jsx("label",{className:"text-xs font-black text-gray-400 uppercase tracking-widest",children:Q}),I.jsx("input",{className:"w-full border-b-2 border-gray-300 p-2 text-center text-xl font-bold bg-transparent outline-none focus:border-teal-500",value:H[Q],onChange:O=>Z({...H,[Q]:O.target.value}),placeholder:"0"})]},Q))})]}),I.jsx("button",{type:"submit",className:`w-full py-8 rounded-[1.5rem] text-white font-black text-4xl shadow-2xl transition transform active:scale-95 active:shadow-none ${q==="internal"?"bg-emerald-600 hover:bg-emerald-700":"bg-teal-600 hover:bg-teal-700"}`,children:"ยืนยันการจองคิว"})]})]}),I.jsxs("button",{onClick:()=>Qe("home"),className:"mt-12 text-emerald-600 font-bold flex items-center gap-3 hover:gap-5 transition-all text-lg",children:[I.jsx(wI,{size:24})," กลับไปที่หน้าหลัก"]})]})},Xt=()=>{var Z,me;const q=y.filter(j=>j.status==="called").slice(0,3),J=y.filter(j=>j.status==="waiting").slice(0,10),H=((me=(Z=D.playlist)==null?void 0:Z[0])==null?void 0:me.id)||U;return I.jsxs("div",{className:"h-screen bg-slate-950 text-white flex flex-col font-sans overflow-hidden",children:[I.jsxs("div",{className:"bg-emerald-900 p-6 flex justify-between items-center border-b-4 border-emerald-500 shadow-2xl z-10",children:[I.jsxs("div",{className:"flex items-center gap-8",children:[I.jsx("img",{src:Ac,className:"h-16 bg-white p-2 rounded-xl shadow-lg"}),I.jsx("h1",{className:"text-5xl font-black italic tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-emerald-200 to-teal-200",children:"คิวรับน้ำมัน"})]}),I.jsxs("div",{className:"text-5xl font-mono bg-black/40 px-10 py-3 rounded-2xl flex items-center gap-6 text-emerald-400 border border-emerald-500/30 backdrop-blur-md",children:[I.jsx(_I,{size:48})," ",new Date().toLocaleTimeString("th-TH",{hour:"2-digit",minute:"2-digit"})]})]}),I.jsxs("div",{className:"flex-1 flex overflow-hidden",children:[I.jsxs("div",{className:"w-5/12 p-8 flex flex-col gap-8 bg-slate-900/50",children:[I.jsxs("h2",{className:"text-3xl font-bold text-yellow-400 animate-pulse flex items-center gap-4 border-b border-white/10 pb-4",children:[I.jsx(Nm,{size:48})," กำลังเรียกคิว"]}),I.jsxs("div",{className:"flex-1 space-y-4",children:[q.map((j,Q)=>I.jsxs("div",{className:`p-8 rounded-3xl border-l-[12px] flex flex-col justify-center shadow-2xl transition-all ${Q===0?"bg-emerald-800 border-yellow-400 scale-105 ring-8 ring-yellow-400/20":"bg-slate-800 border-slate-600 opacity-60"}`,children:[I.jsxs("div",{className:"flex justify-between items-center mb-2",children:[I.jsx("div",{className:"text-7xl font-black tracking-tighter drop-shadow-lg",children:j.plateNumber}),I.jsx("div",{className:"text-2xl bg-yellow-400 text-black px-6 py-1 rounded-full font-black animate-bounce shadow-xl",children:"เชิญครับ"})]}),I.jsx("div",{className:"text-3xl text-emerald-300 font-bold text-right italic",children:j.station})]},j.id)),q.length===0&&I.jsx("div",{className:"h-full flex items-center justify-center text-gray-600 text-2xl italic font-bold",children:"รอเรียกคิว..."})]}),I.jsxs("div",{className:"h-1/3 pt-8 border-t border-white/10",children:[I.jsx("h3",{className:"text-2xl font-bold text-emerald-400 mb-4",children:"คิวรอถัดไป"}),I.jsx("div",{className:"grid grid-cols-2 gap-4",children:J.map(j=>I.jsxs("div",{className:"bg-slate-800 p-4 rounded-2xl flex justify-between items-center border border-white/5 shadow-md",children:[I.jsx("span",{className:"text-2xl font-black text-white",children:j.plateNumber}),I.jsx("span",{className:"text-sm text-slate-400 font-bold truncate max-w-[150px]",children:j.station})]},j.id))})]})]}),I.jsxs("div",{className:"w-7/12 bg-black relative shadow-2xl",children:[I.jsx("iframe",{className:"w-full h-full",src:`https://www.youtube.com/embed/${H}?autoplay=1&mute=1&controls=0&loop=1&playlist=${H}`,allow:"autoplay"}),I.jsx("div",{className:"absolute bottom-0 w-full bg-red-700/90 py-6 text-white overflow-hidden whitespace-nowrap border-t-8 border-red-500 shadow-2xl",children:I.jsx("div",{className:"animate-marquee inline-block text-4xl font-black px-10 tracking-widest uppercase",children:"📢 กรุณาเตรียมเอกสารใบสั่งงานให้พร้อม... ขับขี่ปลอดภัย ใส่ใจกฎจราจร... PTG Energy ยินดีให้บริการ..."})})]})]}),I.jsx("style",{children:`
                @keyframes marquee { 0% { transform: translateX(100%); } 100% { transform: translateX(-100%); } }
                .animate-marquee { animation: marquee 35s linear infinite; display: inline-block; }
            `})]})},Yt=()=>{const q=()=>I.jsxs("div",{className:"space-y-6",children:[I.jsxs("div",{className:"flex flex-col lg:flex-row justify-between items-start lg:items-center bg-white p-6 rounded-3xl shadow-sm border border-emerald-100 gap-6",children:[I.jsxs("h2",{className:"text-3xl font-black text-emerald-900",children:["จัดการคิวรถวันนี้ (",y.length,")"]}),I.jsxs("div",{className:"flex flex-wrap items-center gap-4 bg-emerald-50 px-6 py-4 rounded-2xl border-2 border-emerald-100 w-full lg:w-auto",children:[I.jsxs("div",{className:"flex flex-col gap-2 w-full sm:w-auto",children:[I.jsxs("label",{className:"text-xs font-black text-emerald-800 uppercase tracking-widest flex items-center gap-2",children:[I.jsx(AI,{size:16})," เลือกเสียงพูด"]}),I.jsx("select",{className:"p-2 border border-emerald-200 rounded-lg text-sm bg-white font-bold text-emerald-900 min-w-[250px] outline-none focus:border-emerald-500",value:E,onChange:Re,children:m.length===0?I.jsx("option",{disabled:!0,children:"กำลังโหลดรายชื่อเสียง..."}):m.map(j=>I.jsxs("option",{value:j.voiceURI,children:[j.name," (",j.lang,")"]},j.voiceURI))}),I.jsx("p",{className:"text-[10px] text-emerald-600 font-bold",children:"* แนะนำเลือกเสียงที่มีคำว่า Google หรือ Thai"})]}),I.jsxs("div",{className:"flex flex-col gap-1 w-full sm:w-auto border-l-2 border-emerald-100 pl-4",children:[I.jsxs("div",{className:"flex items-center gap-4 text-xs font-black text-emerald-800 uppercase",children:["Speed ",I.jsx("input",{type:"range",min:"0.5",max:"1.5",step:"0.1",value:R,onChange:j=>T(parseFloat(j.target.value)),className:"accent-emerald-500 h-1.5 w-24"})]}),I.jsxs("div",{className:"flex items-center gap-4 text-xs font-black text-emerald-800 uppercase",children:["Pitch ",I.jsx("input",{type:"range",min:"0.5",max:"1.5",step:"0.1",value:gt,onChange:j=>Tn(parseFloat(j.target.value)),className:"accent-emerald-500 h-1.5 w-24"})]})]})]})]}),I.jsxs("div",{className:"grid grid-cols-1 gap-6",children:[y.map(j=>I.jsxs("div",{className:`bg-white p-8 rounded-[2rem] shadow-xl border-l-[12px] flex flex-col md:flex-row justify-between items-center transition-all hover:scale-[1.01] ${j.status==="called"?"border-emerald-500 bg-emerald-50/40":"border-gray-200"}`,children:[I.jsxs("div",{className:"flex items-center gap-10 w-full md:w-auto mb-4 md:mb-0",children:[I.jsx("div",{className:"text-6xl font-black text-emerald-900 bg-emerald-50 w-32 h-32 flex items-center justify-center rounded-3xl border-4 border-white shadow-xl",children:j.queueNumber}),I.jsxs("div",{children:[I.jsx("h3",{className:"text-4xl font-bold text-gray-800 tracking-tight",children:j.plateNumber}),I.jsxs("p",{className:"text-xl text-gray-500 font-bold mt-2 flex items-center gap-2",children:[I.jsx(Pm,{size:24,className:"text-emerald-500"})," ",j.station]}),I.jsxs("div",{className:"mt-4 flex gap-3",children:[I.jsx("span",{className:`px-4 py-1 rounded-full text-xs font-black tracking-widest uppercase border ${j.type==="internal"?"bg-blue-50 text-blue-700 border-blue-100":"bg-purple-50 text-purple-700 border-purple-100"}`,children:j.type}),I.jsx("span",{className:"px-4 py-1 rounded-full text-xs font-black bg-gray-50 text-gray-400 border border-gray-100 tracking-widest uppercase",children:j.statusText})]})]})]}),I.jsxs("div",{className:"flex gap-4 w-full md:w-auto justify-end",children:[I.jsx("button",{onClick:()=>oe(j),className:"bg-emerald-600 text-white p-6 rounded-2xl hover:bg-emerald-700 shadow-xl transition-all active:scale-90",children:I.jsx(Nm,{size:32})}),I.jsx("button",{onClick:()=>Te(j),className:"bg-blue-600 text-white p-6 rounded-2xl hover:bg-blue-700 shadow-xl transition-all active:scale-90",children:I.jsx(xm,{size:32})}),I.jsx("button",{onClick:()=>kc(tn(i,"artifacts",o,"public","data","queues",j.id)),className:"bg-red-50 text-red-500 p-6 rounded-2xl hover:bg-red-500 hover:text-white transition-all active:scale-90",children:I.jsx(bm,{size:32})})]})]},j.id)),y.length===0&&I.jsx("div",{className:"text-center py-20 text-gray-300 italic font-bold text-xl bg-white rounded-3xl border-2 border-dashed",children:"ไม่มีคิวรับงานในขณะนี้..."})]})]}),J=()=>{const j=ye.useRef(),Q=ne=>{const ae=ne.target.files[0];if(!ae||!window.XLSX)return;const Xe=new FileReader;Xe.onload=Jt=>{try{const Ft=new Uint8Array(Jt.target.result),un=window.XLSX.read(Ft,{type:"array"}),Vr=un.SheetNames.map((cn,Wn)=>{const Wo=un.Sheets[cn],We=window.XLSX.utils.sheet_to_json(Wo,{header:1});let Ue=[],qn=[],ui=!1;return We.forEach((hs,Tu)=>{if(!Array.isArray(hs))return;const jt=hs.map(Ut=>Ut!=null?String(Ut).trim():"");if(!ui&&(jt.includes("Trip No.")||jt.includes("ชื่อลูกค้า"))){ui=!0,Ue=jt.map(Ut=>Ut||"");return}if(ui&&jt.some(Ut=>Ut!=="")){const Ut=Ue.map((Iu,ci)=>jt[ci]!==void 0?jt[ci]:"");qn.push({id:Date.now()+Tu+Math.random(),cells:Ut})}}),qn.length>0?{id:"s"+Date.now()+Wn,name:cn||"Sheet",headers:Ue,rows:qn}:null}).filter(Boolean);Vr.length?(Vr.forEach(cn=>{const Wn=JSON.parse(JSON.stringify(cn));Ic(tn(i,"artifacts",o,"public","data","sheets",Wn.id),Wn)}),alert("นำเข้าฐานข้อมูลเที่ยวรถสำเร็จ "+Vr.length+" แผ่นงาน")):alert("ไม่พบข้อมูลเที่ยวรถในไฟล์ที่เลือก")}catch(Ft){alert("เกิดข้อผิดพลาดในการอ่านไฟล์: "+Ft.message)}},Xe.readAsArrayBuffer(ae)},O=V.find(ne=>ne.id===w)||V[0],re=O==null?void 0:O.headers.findIndex(ne=>ne==null?void 0:ne.includes("เบอร์รถ"));return I.jsxs("div",{className:"bg-white rounded-[2rem] shadow-xl p-10 min-h-[600px] flex flex-col border border-emerald-100 animate-in fade-in duration-500",children:[I.jsxs("div",{className:"flex justify-between items-center mb-10",children:[I.jsxs("div",{children:[I.jsxs("h2",{className:"text-3xl font-black text-gray-800 flex gap-4",children:[I.jsx(Rm,{className:"text-emerald-600",size:36})," ฐานข้อมูลเที่ยวรถ"]}),I.jsx("p",{className:"text-gray-400 font-bold mt-1 text-sm tracking-tight",children:"* สามารถแก้ไขเลขเบอร์รถในตารางเพื่อจับคู่คิวอัตโนมัติ"})]}),I.jsxs("div",{className:"flex gap-4",children:[I.jsx("input",{type:"file",ref:j,hidden:!0,onChange:Q,accept:".xlsx,.xls,.csv"}),I.jsxs("button",{onClick:()=>j.current.click(),className:"bg-emerald-600 text-white px-8 py-3 rounded-2xl font-black text-lg hover:bg-emerald-700 shadow-xl transition-all flex items-center gap-2",children:[I.jsx(xI,{size:24})," Import Excel"]})]})]}),I.jsx("div",{className:"flex gap-3 mb-6 overflow-x-auto pb-4 scrollbar-hide",children:V.map(ne=>I.jsx("button",{onClick:()=>k(ne.id),className:`px-6 py-2 rounded-xl text-sm font-black whitespace-nowrap border-2 transition-all ${w===ne.id?"bg-emerald-100 border-emerald-500 text-emerald-800 shadow-md":"bg-gray-50 border-gray-100 text-gray-400"}`,children:ne.name},ne.id))}),I.jsx("div",{className:"flex-1 overflow-auto border-4 border-emerald-50 rounded-2xl shadow-inner bg-gray-50",children:I.jsxs("table",{className:"w-full text-left whitespace-nowrap bg-white text-sm",children:[I.jsx("thead",{className:"bg-emerald-50 sticky top-0 font-bold text-emerald-900 border-b-2 border-emerald-100 z-10",children:I.jsx("tr",{children:O==null?void 0:O.headers.map((ne,ae)=>I.jsx("th",{className:"p-4",children:ne},ae))})}),I.jsxs("tbody",{children:[O==null?void 0:O.rows.map(ne=>I.jsx("tr",{className:"border-b border-emerald-50 hover:bg-emerald-50/50 transition-colors",children:ne.cells.map((ae,Xe)=>I.jsx("td",{className:`p-4 ${Xe===re?"bg-yellow-50 font-black text-emerald-800":""}`,children:Xe===re?I.jsx("input",{className:"w-full bg-transparent outline-none border-b-2 border-transparent focus:border-emerald-500 font-black",value:ae,onChange:async Jt=>{const Ft=O.rows.map(un=>un.id===ne.id?{...un,cells:un.cells.map((Vr,cn)=>cn===Xe?Jt.target.value:Vr)}:un);await Sc(tn(i,"artifacts",o,"public","data","sheets",O.id),{rows:Ft})}}):ae},Xe))},ne.id)),(O==null?void 0:O.rows.length)===0&&I.jsx("tr",{children:I.jsx("td",{colSpan:O.headers.length||1,className:"p-10 text-center text-gray-300 italic",children:"กรุณานำเข้าข้อมูลเที่ยวรถเพื่อเริ่มต้น"})})]})]})})]})},H=()=>{const j={trucks:{},stations:{}};P.forEach(O=>{var re;if(O.type==="internal"){const ne=O.plateNumber||"N/A";j.trucks[ne]=(j.trucks[ne]||0)+1;const ae=((re=O.station)==null?void 0:re.split("-")[0])||"N/A";j.stations[ae]=(j.stations[ae]||0)+1}});const Q=O=>Object.entries(O).sort((re,ne)=>ne[1]-re[1]).slice(0,10);return I.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-10 animate-in slide-in-from-bottom-4 duration-500",children:[I.jsxs("div",{className:"bg-white p-10 rounded-[2.5rem] shadow-xl border border-emerald-100",children:[I.jsxs("h3",{className:"text-3xl font-black mb-8 flex gap-4 text-gray-800 border-b pb-4",children:[I.jsx(hc,{className:"text-emerald-600"})," ยอดวิ่งสูงสุด (Internal)"]}),I.jsx("div",{className:"space-y-4",children:Q(j.trucks).map(([O,re],ne)=>I.jsxs("div",{className:"flex justify-between items-center p-4 bg-gray-50 rounded-2xl border border-emerald-50",children:[I.jsxs("div",{className:"flex gap-4 items-center",children:[I.jsx("span",{className:"w-8 h-8 bg-emerald-600 text-white rounded-full flex items-center justify-center font-bold",children:ne+1}),I.jsx("span",{className:"font-bold text-xl",children:O})]}),I.jsxs("span",{className:"text-2xl font-black text-emerald-600",children:[re," เที่ยว"]})]},O))})]}),I.jsxs("div",{className:"bg-white p-10 rounded-[2.5rem] shadow-xl border border-teal-100",children:[I.jsxs("h3",{className:"text-3xl font-black mb-8 flex gap-4 text-gray-800 border-b pb-4",children:[I.jsx(Pm,{className:"text-teal-600"})," สถานีที่รับงานสูงสุด"]}),I.jsx("div",{className:"space-y-4",children:Q(j.stations).map(([O,re],ne)=>I.jsxs("div",{className:"flex justify-between items-center p-4 bg-gray-50 rounded-2xl border border-teal-50",children:[I.jsxs("div",{className:"flex gap-4 items-center",children:[I.jsx("span",{className:"w-8 h-8 bg-teal-600 text-white rounded-full flex items-center justify-center font-bold",children:ne+1}),I.jsx("span",{className:"font-bold text-xl",children:O})]}),I.jsxs("span",{className:"text-2xl font-black text-teal-600",children:[re," รอบ"]})]},O))})]})]})},Z=()=>I.jsxs("div",{className:"bg-white rounded-[2rem] shadow-xl p-10 border border-emerald-100 overflow-hidden animate-in fade-in duration-500",children:[I.jsxs("div",{className:"flex justify-between items-center mb-8",children:[I.jsxs("h2",{className:"text-3xl font-black flex gap-4 text-emerald-900",children:[I.jsx(Cm,{size:40})," ประวัติการเรียกคิว"]}),I.jsx("button",{onClick:ge,className:"bg-red-50 text-red-500 px-6 py-2 rounded-xl font-bold hover:bg-red-500 hover:text-white transition-all shadow-sm",children:"ล้างประวัติทั้งหมด"})]}),I.jsx("div",{className:"overflow-x-auto rounded-2xl border border-gray-100 shadow-inner",children:I.jsxs("table",{className:"w-full text-left text-base bg-white",children:[I.jsx("thead",{className:"bg-gray-50 text-gray-400 font-black uppercase text-xs tracking-widest border-b",children:I.jsxs("tr",{children:[I.jsx("th",{className:"p-6",children:"วัน/เวลา"}),I.jsx("th",{className:"p-6",children:"หมายเลขคิว"}),I.jsx("th",{className:"p-6",children:"ทะเบียน/เบอร์รถ"}),I.jsx("th",{className:"p-6",children:"รายละเอียด"})]})}),I.jsx("tbody",{children:P.map(j=>I.jsxs("tr",{className:"border-b border-gray-50 hover:bg-gray-50/50 transition-colors",children:[I.jsx("td",{className:"p-6 font-medium text-gray-500",children:new Date(j.timestamp).toLocaleString("th-TH")}),I.jsx("td",{className:"p-6 font-black text-emerald-700",children:j.queueNumber}),I.jsx("td",{className:"p-6 font-bold",children:j.type==="internal"?j.plateNumber:j.name}),I.jsx("td",{className:"p-6 text-gray-500 font-medium",children:j.type==="internal"?j.station:j.company})]},j.id))})]})})]}),me=()=>{var ne;const[j,Q]=ye.useState(""),O=ae=>Ic(tn(i,"artifacts",o,"public","data","config","youtube"),ae),re=()=>{var Xe;const ae=(Xe=j.match(/(?:youtu\.be\/|v\/|u\/\w\/|embed\/|watch\?v=|&v=)([^#&?]*).*/))==null?void 0:Xe[1];(ae==null?void 0:ae.length)===11?(O({...D,playlist:[...D.playlist||[],{id:ae,url:j,at:new Date().toISOString()}]}),Q("")):alert("รูปแบบลิงก์ไม่ถูกต้อง")};return I.jsxs("div",{className:"bg-white rounded-[2rem] shadow-xl p-10 border border-red-100 animate-in slide-in-from-bottom-4 duration-500",children:[I.jsxs("h2",{className:"text-3xl font-black flex gap-4 text-red-600 mb-8 items-center",children:[I.jsx(Dm,{size:40})," จัดการวิดีโอบนหน้าจอ TV"]}),I.jsxs("div",{className:"flex gap-4 mb-10",children:[I.jsx("input",{className:"flex-1 p-6 border-4 border-red-50 rounded-2xl text-xl font-bold focus:border-red-500 outline-none transition-all",placeholder:"วางลิงก์ YouTube ที่นี่...",value:j,onChange:ae=>Q(ae.target.value)}),I.jsx("button",{onClick:re,className:"bg-red-600 text-white px-10 rounded-2xl font-black text-xl hover:bg-red-700 shadow-xl shadow-red-100 transition-all active:scale-95",children:"เพิ่มวิดีโอ"})]}),I.jsx("div",{className:"grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6",children:(ne=D.playlist)==null?void 0:ne.map(ae=>I.jsxs("div",{className:"relative group rounded-3xl overflow-hidden shadow-lg aspect-video border-4 border-gray-100 hover:border-red-400 transition-all",children:[I.jsx("img",{src:`https://img.youtube.com/vi/${ae.id}/maxresdefault.jpg`,className:"w-full h-full object-cover",alt:"Thumb"}),I.jsx("div",{className:"absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center",children:I.jsx("button",{onClick:()=>O({...D,playlist:D.playlist.filter(Xe=>Xe.id!==ae.id)}),className:"bg-white p-4 rounded-full text-red-600 hover:scale-110 transition-transform shadow-2xl",children:I.jsx(bm,{size:24})})})]},ae.id))})]})};return I.jsxs("div",{className:"min-h-screen bg-gray-50 flex flex-col font-sans",children:[I.jsxs("header",{className:"bg-white border-b-4 border-emerald-500 sticky top-0 z-50 px-6 lg:px-10 py-4 flex flex-col md:flex-row justify-between items-center shadow-xl gap-4",children:[I.jsxs("div",{className:"flex items-center gap-6 cursor-pointer group",onClick:()=>Qe("home"),children:[I.jsx("img",{src:Ac,className:"h-10 lg:h-14 bg-emerald-50 p-2 rounded-xl group-hover:scale-110 transition-transform"}),I.jsx("h1",{className:"text-2xl lg:text-4xl font-black text-emerald-900 tracking-tighter uppercase",children:"Admin Center"})]}),I.jsx("div",{className:"flex gap-1 lg:gap-2 bg-gray-100 p-1.5 rounded-3xl overflow-x-auto max-w-full",children:[{id:"dashboard",label:"คิวงาน",icon:I.jsx(EI,{size:20})},{id:"trips",label:"เที่ยวรถ",icon:I.jsx(Rm,{size:20})},{id:"youtube",label:"วิดีโอ TV",icon:I.jsx(Dm,{size:20})},{id:"stats",label:"รายงาน",icon:I.jsx(vI,{size:20})},{id:"history",label:"ประวัติ",icon:I.jsx(Cm,{size:20})}].map(j=>I.jsxs("button",{onClick:()=>Qe(`admin/${j.id}`),className:`px-4 lg:px-8 py-2.5 lg:py-3 rounded-[1.2rem] font-black flex items-center gap-2 lg:gap-3 transition-all whitespace-nowrap ${f===j.id?"bg-emerald-600 text-white shadow-lg scale-105":"text-gray-400 hover:text-gray-600"}`,children:[j.icon," ",I.jsx("span",{className:"hidden sm:inline",children:j.label})]},j.id))}),I.jsx("button",{onClick:()=>Qe("home"),className:"bg-red-50 text-red-500 hover:bg-red-500 hover:text-white p-3 lg:p-4 rounded-2xl transition-all shadow-sm",children:I.jsx(II,{size:24})})]}),I.jsxs("main",{className:"flex-1 p-4 lg:p-12 max-w-screen-2xl mx-auto w-full",children:[f==="dashboard"&&I.jsx(q,{}),f==="trips"&&I.jsx(J,{}),f==="youtube"&&I.jsx(me,{}),f==="stats"&&I.jsx(H,{}),f==="history"&&I.jsx(Z,{})]})]})};return t?u==="kiosk"?I.jsx(Qt,{}):u==="tv"?I.jsx(Xt,{}):u==="admin"?I.jsx(Yt,{}):I.jsx("div",{className:"min-h-screen bg-gradient-to-br from-green-50 via-emerald-100 to-teal-100 flex items-center justify-center p-4",children:I.jsxs("div",{className:"max-w-4xl w-full text-center bg-white/40 backdrop-blur-xl p-8 lg:p-16 rounded-[3rem] shadow-2xl border border-white/50 animate-in zoom-in duration-500",children:[I.jsx("img",{src:Ac,className:"h-32 lg:h-40 mx-auto mb-8 drop-shadow-xl p-4 bg-white/80 rounded-3xl shadow-emerald-200/50",alt:"PTG Logo"}),I.jsx("h1",{className:"text-5xl lg:text-7xl font-black text-emerald-900 mb-4 tracking-tight",children:"PTG Smart Queue"}),I.jsx("p",{className:"text-emerald-700 text-xl lg:text-2xl mb-12 font-bold uppercase tracking-widest opacity-80",children:"Petroleum Thai Corporation"}),I.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-3 gap-8",children:[I.jsxs("button",{onClick:()=>Qe("kiosk"),className:"bg-white p-10 rounded-[2rem] shadow-xl hover:shadow-emerald-200/50 hover:-translate-y-2 transition-all group border-b-8 border-emerald-500",children:[I.jsx(RI,{size:64,className:"mx-auto text-emerald-500 mb-4 group-hover:scale-110 transition-transform"}),I.jsx("h2",{className:"text-2xl font-bold text-gray-800 uppercase tracking-tighter",children:"Kiosk"})]}),I.jsxs("button",{onClick:()=>Qe("tv"),className:"bg-white p-10 rounded-[2rem] shadow-xl hover:shadow-teal-200/50 hover:-translate-y-2 transition-all group border-b-8 border-teal-500",children:[I.jsx(SI,{size:64,className:"mx-auto text-teal-500 mb-4 group-hover:scale-110 transition-transform"}),I.jsx("h2",{className:"text-2xl font-bold text-gray-800 uppercase tracking-tighter",children:"TV Display"})]}),I.jsxs("button",{onClick:()=>Qe("admin"),className:"bg-white p-10 rounded-[2rem] shadow-xl hover:shadow-green-200/50 hover:-translate-y-2 transition-all group border-b-8 border-green-600",children:[I.jsx(kI,{size:64,className:"mx-auto text-green-600 mb-4 group-hover:scale-110 transition-transform"}),I.jsx("h2",{className:"text-2xl font-bold text-gray-800 uppercase tracking-tighter",children:"Admin"})]})]})]})}):I.jsxs("div",{className:"h-screen bg-green-50 flex flex-col items-center justify-center text-emerald-600",children:[I.jsx(TI,{size:100,className:"animate-spin mb-6 opacity-30"}),I.jsx("h1",{className:"text-4xl font-black animate-pulse",children:"กำลังเริ่มระบบ Smart Queue..."})]})}s_(document.getElementById("root")).render(I.jsx(ye.StrictMode,{children:I.jsx(h2,{})}));
